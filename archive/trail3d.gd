#https://gist.githubusercontent.com/axilirate
...
class Point:
	...
	func _init(transform2 :Transform3D, age2 :float) -> void:
...
func add_point(transform2 :Transform3D) -> void:
	var point =  Point.new(transform2, lifetime)
